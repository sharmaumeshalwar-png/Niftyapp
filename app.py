...
st.set_page_config(page_title="Nifty Column M Matrix 2026", layout="wide")
...
st.markdown("""
    <div class="title-block">
        <h1>🎯 Nifty 50 Pure Cascade (2026 Active Matrix)</h1>
        <p><b>Data Target:</b> From 1 Jan 2026 onwards | <b>Column L:</b> (I row 2) - (I row 1) Value Only<br>
...
def load_pure_data():
    # Fetching 2 years data to maintain the correct historical EMA initialization
...
if not df.empty:
    ...
    # 3. CORE 5-STAGE MATHEMATICAL CASCADE (Counting up to step 8)
    # Step 1: Mid Price
