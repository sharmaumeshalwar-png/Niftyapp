# ------------------------------------------------------------------
# 🔥 FIX: Initialization of State and Accumulator (Line 116 Fix)
# ------------------------------------------------------------------
...
# Storage Lists Initialization
scores_log = []
raw_weighted_momentum_log = []
final_signals = []

# Core State Machine Initialization (Yeh variables loop se pehle hona zaroori hain)
current_state = None  # Tracks trend state: "BUY", "SELL", or None
accumulator = 0       # Tracks score momentum points
...
for idx, row in df_predict.iterrows():
    ...
    # Probability Based Scoring Logic
    if p_up > p_down:
        accumulator += 1
    elif p_down > p_up:
        accumulator -= 1
