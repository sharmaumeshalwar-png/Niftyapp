...
st.title("⚡ BTC Heikin-Ashi Dual Engine + Price-Action Liquidity Engine")
st.caption("1-Hour HA Frozen + 15-Min Dynamic Grid with Zero-Lag Hull Orderflow")

# =====================================================================
# 🌐 BINANCE PIPELINE & DYNAMIC PRICE-ACTION ABSORPTION ENGINE
# =====================================================================
def fetch_btc_data_binance():
    ...
    def process_df(df_raw):
        ...
        # 🎯 DYNAMIC LIQUIDITY ABSORPTION ENGINE
...
# =====================================================================
with st.spinner("Fetching Binance BTC Data & Computing Indicators..."):
    df_1h_raw, df_15m_raw = fetch_btc_data_binance()

if df_1h_raw.empty or df_15m_raw.empty:
    st.error("🚨 Data Fetching Error. Please check your network connection.")
    st.stop()
...
# Kinematic State Engine + Invalidation Logic
n = len(df_15m_grid)
...
st.subheader("📋 Heikin-Ashi Dual Timeframe Timeline with Dynamic Orderflow")

clean_cols = [
    '1H_HA_Close_Frozen', 'HA_Close', 'HA_HAM_1H_Frozen', 'HA_HAM', 
...
num_cols = [
    '1H HA Close', '15M HA Close', '1H Locked HA-HAM', '15M Live HA-HAM',
    'Dynamic Buy Vol', 'Dynamic Sell Vol', 'Net Vol Delta (%)', 
