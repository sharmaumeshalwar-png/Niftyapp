...
st.title("🦅 Nifty & India VIX Daily Macro Dashboard")

st.write("Fixed Architecture: Daily Continuous Interval | 730-Day Historical Data | Q=0.50 | Pure Signals...")

# 1. OPTIMIZED FUNCTION FOR DAILY DATA FETCHING
...
def load_daily_data():
    ...
    # Fetching Daily Data (Aapka same logic, interval='1d')
...
if combined_data is None or len(combined_data) == 0:
    ...
    # 2. GAP DE-TRENDING ENGINE FOR DAILY CANDLES (Aapka Same Float Logic)
    ...
    # 6. NON-REPAINT TREND SIGNALS FOR DAILY BANDS
    nifty_signals = []
