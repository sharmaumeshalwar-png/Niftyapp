...
st.write("🎯 **Original Logic:** Nifty Data | 50:50 Split | 25-Candle Target | VIX-Synced Accumulator")
...
def get_vix_factor():
    try:
        # VIX fetch (last 1 hour data point)
...
with st.spinner("Processing 2-Years Nifty Microstructure..."):
    # 2 Years Data
